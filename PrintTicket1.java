...
public class PrintTicket1 extends JFrame
{
	public PrintTicket1(String sFrom, String sTo, String sClass, Integer iAdult, Integer iChildren, Integer iInfant, String sBookingDate, Integer iPrice, String sTime)
	{
		...
		JLabel LWishes = new JLabel("<html><body><I><font color=\"#D2B48C\">Wish You A Very Happy Journey!!</font></I></body></html>");
		...
		JLabel LRushin=new JLabel("<html><I><font color=\"#8FBC8F\">Rushin Patel</font></I></html>");
		JLabel LRaj=new JLabel("<html><I><font color=\"#8FBC8F\">Raj Shah</font></I></html>");
		JLabel LRutva=new JLabel("<html><I><font color=\"#8FBC8F\">Rutva Thaker</font></I></html>");
		JLabel LKhushali=new JLabel("<html><I><font color=\"#8FBC8F\">Khushali Sheth</font></I></html>");
		...
		LRushin.setBounds(285,485,300,20);
		LRaj.setBounds(285,505,300,20);
		LRutva.setBounds(285,525,300,20);
		LKhushali.setBounds(285,545,300,20);
